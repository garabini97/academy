...
define('USER_REGISTRATION_FAIL', 'Registro Falhou');
define('USER_REGISTRATION_SUCCESS', 'Registrado com sucesso, Faça seu Login !');
...
define('LOGOUT_SUCCESS', 'Sessão finalizada com sucesso !');
define('CHOOSE_CATEGORY', 'Escolha a categoria');
